...
Union ([<span class="underline">TikTok,
n.d.</span>](https://developers.tiktok.com/products/research-api/)). As
Brazil – and most of the world – fall outside this scope, researchers in
other regions are limited to data scraping capabilities
([<span class="underline">Chemillier et al.,
2022</span>](https://hal.science/hal-04454074/)).
...
in Brazil or affiliated with Brazilian institutions
([<span class="underline">TikTok,
n.d.</span>](https://developers.tiktok.com/products/research-api/)).
...
[<span class="underline">https://hal.science/hal-04454074/</span>](https://hal.science/hal-04454074/)

TikTok. (n.d.). *Research Tools*. TikTok for developers.
[<span class="underline">https://developers.tiktok.com/products/research-api/</span>](https://developers.tiktok.com/products/research-api/)
