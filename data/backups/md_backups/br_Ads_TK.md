...
includes data from ads served to users in the European Economic Area,
Switzerland and the United Kingdom. The TikTok Commercial Content
Library
([<span class="underline">n.d.</span>](https://library.tiktok.com/ads)),
launched in 2023 to comply with the Digital Services Act (DSA), does not
include data from other regions ([<span class="underline">TikTok,
...
users in the European Union ([<span class="underline">TikTok,
n.d.</span>](https://support.tiktok.com/en/account-and-privacy/personalized-ads-and-data/commercial-content-library)),
...
TikTok. (n.d.). *Commercial Content Library*. TikTok.
[<span class="underline">https://support.tiktok.com/en/account-and-privacy/personalized-ads-and-data/commercial-content-library</span>](https://support.tiktok.com/en/account-and-privacy/personalized-ads-and-data/commercial-content-library)

TikTok Commercial Content Library. (n.d.). *TikTok Commercial Content
Library*.
[<span class="underline">https://library.tiktok.com/ads</span>](https://library.tiktok.com/ads)
