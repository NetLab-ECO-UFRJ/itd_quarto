...
The platform provides an API to access its ad repository, but it only
includes data from ads served to users in the European Union. The X Ads
Repository, launched in 2023 to comply with the Digital Services Act
(DSA), does not include data from other regions
([<span class="underline">X Business,
...
The X Ads Repository includes a graphical user interface that allows
users to extract advertising content data, but it is limited to ads
served to users within the European Union ([<span class="underline">X
Ads Repository, n.d.</span>](https://ads.twitter.com/ads-repository)).
...
As the platform’s ad repository only includes data from ads served to
users in the European Union ([<span class="underline">X Business,
n.d.</span>](https://business.x.com/en/help/ads-policies/product-policies/ads-transparency)),
this item does not apply to the assessment of transparency and data
...
X Ads Repository. (n.d.). *X*.
[<span class="underline">https://ads.twitter.com/ads-repository</span>](https://ads.twitter.com/ads-repository)

X Business. (n.d.). *Ads transparency*. X.
[<span class="underline">https://business.x.com/en/help/ads-policies/product-policies/ads-transparency</span>](https://business.x.com/en/help/ads-policies/product-policies/ads-transparency)
