...
This criterion requires code development [<span class="underline">Rafael
Tadeu Cardoso dos
Santos</span>](mailto:rafael.cardoso@netlab.eco.ufrj.br)

**Justification:**

X/Twitter provides a longstanding API ([<span class="underline">X,
n.d.-l</span>](https://developer.x.com/en/docs/x-api)) that has been
extensively documented and widely used for academic research (see
[<span class="underline">Dongo et al.,
2020</span>](https://doi.org/10.1145/3428757.3429104)). It remains
accessible to anyone with a registered developer account, although, as
will be discussed further, such access is now mostly paid
([<span class="underline">Mimizuka et al.,
2025</span>](https://arxiv.org/abs/2505.09877)).
...
accessed and explored by developers through its API
([<span class="underline">Johnson,
2018</span>](https://blog.x.com/developer/en_us/topics/tools/2018/twitter-developer-platform-and-user-privacy)).
...
the use of its API ([<span class="underline">Nóbrega,
2023</span>](https://desinformante.com.br/twitter-api/)), which had
previously been mostly free of charge ([<span class="underline">Mimizuka
et al., 2025</span>](https://arxiv.org/abs/2505.09877)). Currently,
access to the API is divided into four levels: (i) Free, which allows
retrieval of data from up to 100 posts per month; (ii) Basic, which, at
a cost of USD 200 per month, allows retrieval of up to 15,000 posts;
(iii) Pro, which, at a cost of USD 5,000 per month, allows retrieval of
up to 1,000,000 posts; and (iv) Enterprise, for which pricing and usage
limits are negotiated directly with the platform
([<span class="underline">X,
n.d.-a</span>](https://docs.x.com/x-api/getting-started/about-x-api)).
As the free plan offers extremely limited capabilities and is presented
by the platform itself as a testing tier ([<span class="underline">X,
n.d.-l</span>](https://developer.x.com/en/docs/x-api)), we do not
...
non-public user-generated content data in Brazil
([<span class="underline">X,
n.d.-m</span>](https://docs.x.com/x-api/fundamentals/data-dictionary)).
...
we take into account the restrictions of the Basic Access tier – such as
the 100-tweet monthly cap, the rate limit of 1 request every 15 minutes
on the main tweet retrieval endpoint, and limited access to certain
endpoints (e.g., *GET /2/tweets/search/all* is not available for Basic
Access tier users) –, then the answer is no. Even if tokens are renewed,
these tier-based restrictions tied to the app/user prevent continuous
...
information about a single tweet, as identified by the provided ID
([<span class="underline">X,
n.d.-c</span>](https://docs.x.com/x-api/posts/get-post-by-id)).
...
identified by the provided ID ([<span class="underline">X,
n.d.-d</span>](https://docs.x.com/x-api/users/get-posts)).
...
The *GET /2/tweets/search/recent* ([<span class="underline">X,
n.d.-i</span>](https://docs.x.com/x-api/posts/search-recent-posts))
...
the *GET /2/tweets/search/all* ([<span class="underline">X,
n.d.-h</span>](https://docs.x.com/x-api/posts/search-all-posts))
...
structure and use of standardized formats ensure significant neutrality–
for example, all timestamps (such as *created\_at*) adhere to the ISO
8601 format and are returned in Coordinated Universal Time (UTC)
([<span class="underline">X,
n.d.-k</span>](https://developer.x.com/en/docs/x-ads-api/timezones)).
Similarly, the *lang* field uses ISO 639-1 language codes, and country
or regional codes follow standard ISO 3166-1 Alpha-2 conventions
([<span class="underline">X,
n.d.-e</span>](https://developer.x.com/en/docs/x-api/v1/developer-utilities/supported-languages/api-reference/get-help-languages)).
...
features or updates ([<span class="underline">X,
n.d.-f</span>](https://docs.x.com/x-api/migrate/overview);
[<span class="underline">n.d.-n</span>](https://developer.x.com/en/support/x-api/v2)).
...
The X/Twitter API documentation is publicly accessible to anyone
([<span class="underline">X,
n.d.-l</span>](https://developer.x.com/en/docs/x-api)).
...
([<span class="underline">X,
n.d.-l</span>](https://developer.x.com/en/docs/x-api)). It also provides
a well-structured migration guide from the previous version to the
current one ([<span class="underline">X,
n.d.-f</span>](https://docs.x.com/x-api/migrate/overview)).
...
([<span class="underline">X,
n.d.-b</span>](https://developer.x.com/en/developer-terms/agreement-and-policy)).
...
([<span class="underline">X API Developers,
n.d.</span>](https://www.postman.com/xapidevelopers/x-api-public-workspace/collection/r90eid4/x-api-v2)).
...
The X/Twitter API documentation is available only in English
([<span class="underline">X,
n.d.-l</span>](https://developer.x.com/en/docs/x-api)).
...
([<span class="underline">X,
n.d.-j</span>](https://docs.x.com/x-api/spaces/introduction)).
...
endpoint ([<span class="underline">X,
n.d.-i</span>](https://docs.x.com/x-api/posts/search-recent-posts)),
...
functionality ([<span class="underline">X,
n.d.-g</span>](https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/rules-filtering)).
...
The *GET /2/tweets/search/recent* ([<span class="underline">X,
n.d.-i</span>](https://docs.x.com/x-api/posts/search-recent-posts)) and
*GET /2/tweets/search/all* ([<span class="underline">X,
n.d.-h</span>](https://docs.x.com/x-api/posts/search-all-posts))
...
[<span class="underline">https://doi.org/10.1145/3428757.3429104</span>](https://doi.org/10.1145/3428757.3429104)

Johnson, R. (2018, April 26). *Twitter developer platform and user
privacy*. Twitter Developer Platform Blog.
[<span class="underline">https://blog.x.com/developer/en\_us/topics/tools/2018/twitter-developer-platform-and-user-privacy</span>](https://blog.x.com/developer/en_us/topics/tools/2018/twitter-developer-platform-and-user-privacy)
...
[<span class="underline">https://doi.org/10.48550/arXiv.2505.09877</span>](https://doi.org/10.48550/arXiv.2505.09877)

Nóbrega, L. (2023, February 2). *Twitter encerra acesso gratuito à API a
partir do dia 9*. desinformante.
[<span class="underline">https://desinformante.com.br/twitter-api/</span>](https://desinformante.com.br/twitter-api/)

X. (n.d.-a). *About the X API*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/getting-started/about-x-api</span>](https://docs.x.com/x-api/getting-started/about-x-api)

X. (n.d.-b). *Developer Agreement and Policy*. X Developer Platform.
[<span class="underline">https://developer.x.com/en/developer-terms/agreement-and-policy</span>](https://developer.x.com/en/developer-terms/agreement-and-policy)

X. (n.d.-c). *Get Post by ID*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/posts/get-post-by-id</span>](https://docs.x.com/x-api/posts/get-post-by-id)

X. (n.d.-d). *Get Posts*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/users/get-posts</span>](https://docs.x.com/x-api/users/get-posts)

X. (n.d.-e). *Get Twitter supported languages*. X Developer Platform.
[<span class="underline">https://developer.x.com/en/docs/x-api/v1/developer-utilities/supported-languages/api-reference/get-help-languages</span>](https://developer.x.com/en/docs/x-api/v1/developer-utilities/supported-languages/api-reference/get-help-languages)

X. (n.d.-f). *Migration Guide: Overview*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/migrate/overview</span>](https://docs.x.com/x-api/migrate/overview)

X. (n.d.-g). *Rules and filtering: Enterprise*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/rules-filtering</span>](https://docs.x.com/x-api/enterprise-gnip-2.0/fundamentals/rules-filtering)

X. (n.d.-h). *Search all Posts*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/posts/search-all-posts</span>](https://docs.x.com/x-api/posts/search-all-posts)

X. (n.d.-i). *Search recent Posts*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/posts/search-recent-posts</span>](https://docs.x.com/x-api/posts/search-recent-posts)

X. (n.d.-j). *Spaces: Introduction*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/spaces/introduction</span>](https://docs.x.com/x-api/spaces/introduction)

X. (n.d.-k). *Timezones*. X Developer Platform.
[<span class="underline">https://developer.x.com/en/docs/x-ads-api/timezones</span>](https://developer.x.com/en/docs/x-ads-api/timezones)

X. (n.d.-l). *X API*. X Developer Platform.
[<span class="underline">https://developer.x.com/en/docs/x-api</span>](https://developer.x.com/en/docs/x-api)

X. (n.d.-m). *X API v2 data dictionary*. X Developer Platform.
[<span class="underline">https://docs.x.com/x-api/fundamentals/data-dictionary</span>](https://docs.x.com/x-api/fundamentals/data-dictionary)

X. (n.d.-n). *X API v2 Support*. X Developer Platform.
[<span class="underline">https://developer.x.com/en/support/x-api/v2</span>](https://developer.x.com/en/support/x-api/v2)

X API Developers. (n.d.). X API v2 \[Postman Collection\]. Postman.
[<span class="underline">https://www.postman.com/xapidevelopers/x-api-public-workspace/collection/r90eid4/x-api-v2</span>](https://www.postman.com/xapidevelopers/x-api-public-workspace/collection/r90eid4/x-api-v2)
