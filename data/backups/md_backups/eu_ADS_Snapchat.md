...
commercial content such as sponsored posts
([<span class="underline">Snapchat,
n.d.</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/Introduction)).
...
well as live commercial content ([<span class="underline">Snapchat,
n.d.</span>](https://adsgallery.snap.com)) . The option to extract data
from the GUI does not appear to exist. In practice, despite multiple
searches using different advertiser snapchat IDs, including brands such
as “Mcdonalds”, “Dior” or “Mcdo\_France” using various country filters
including individual countries and “all EU countries”, no data was
returned by the GUI.
...
([<span class="underline">Snapchat,
n.d.</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api)).
...
not rely on OAuth or other token-based access
([<span class="underline">Snapchat,
n.d.</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api)).
...
[<span class="underline">https://adsapi.snapchat.com/v1/ads\_library/ads/{ad\_id</span>](https://adsapi.snapchat.com/v1/ads_library/ads/%7Bad_id)}
...
assessment ([<span class="underline">Snapchat,
n.d.</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api)).
...
name”([<span class="underline">Snapchat,
n.d.</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api)).
...
providing data about ads’ funders ([<span class="underline">Snapchat,
n.d.</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api)).
This cannot be verified via the API nor the GUI as they do not appear to
be functioning at the time of this assessment.
...
The API documentation is clearly written and exemplified
[<span class="underline">(Snapchat,
n.d.)</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api);
however, the GUI documentation is minimal and is provided on the landing
page [<span class="underline">(Snapchat,
n.d</span>](https://adsgallery.snap.com).)
...
any deprecation strategies [<span class="underline">(Snapchat,
n.d.)</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api).
...
Detailed explanations are provided in the API documentation
[<span class="underline">(Snapchat,
n.d.)</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api).
...
This information is not available in the API documentation
[<span class="underline">(Snapchat,
n.d.)</span>](https://developers.snap.com/api/marketing-api/Ads-Gallery-Api/using-the-api);
